...
| `agentic-guardrails` | `v0.4.4` | `v0.4.4` | Enterprise guardrails: CRUA, bounded automatic recovery retention, agent workspace, sync-aware safety, policy-driven blocking. |
| `professor-synapse` | `v2.8.0` | — | A router that summons expert agents on demand, with agent-tagged memory and a summon-gate. |
