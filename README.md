...
| `agentic-guardrails` | `v0.4.1` | `v0.4.1` | Enterprise guardrails: CRUA, bounded automatic recovery retention, agent workspace, sync-aware safety, policy-driven blocking. |
