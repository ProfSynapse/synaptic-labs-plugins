...
| `agentic-guardrails` | `v0.3.26` | `v0.3.26` | Enterprise guardrails: CRUA, bounded automatic recovery retention, agent workspace, sync-aware safety, policy-driven blocking. |
